...
export default function WorkingtoolsType() {
    const navigate = useNavigate();
    const testdata = [
        {
            "Name": "Working tool Type1",
        },
        {
            "Name": "Working tool Type2",
        },
    ];
...
const TestMockTable = (props: TableProps) => {
    ...
    return (
        <div className="px-3">
            <div className="">
                <Breadcrump title="Types" navigation={['People Management', 'Working Tools', 'Settings', 'Types']} />
            </div>
            <div className="mt-4">
                <Table
                    data={props.data}
