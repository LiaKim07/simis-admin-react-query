...
const defaultState: any = {
    ...
    "number": "string",
    "equipmentId": '',
    "validUntil": new Date().toJSON().slice(0, 10),
    "pricePerUnit": "",
    "createdBy": tokenData,
    "employeeId": "string",
};

export default function AddNewIssuePurchasesModals({
    setShow,
    isUpdating = false,
    handleSuccess,
    ...props
                ...
                <Modal.Body>
                    <div className="body-header p-4 mb-2 d-flex justify-content-between">
                        <Heading fontWeight="bold" fontSize="xl">
                            {isUpdating ? 'Update Issue' : 'Naujas pirkimas'}
                        </Heading>
                    ...
                    <div className="body-content px-4 modal-border">
                        <Collapsible isOpen={true} title="Pirkimo informacija">
