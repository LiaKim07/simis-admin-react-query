...
import AddNewLiftingCapacityModal from "./AddNewLiftingCapacityModal";
import RemoveModal from "../Modals/RemoveConfirmModal";

export default function LiftingCapacityInfo(props: { data: any }) {
    ...
    const handleClickConfirm = async () => {
        ...
        //         toast.success('MeasurementUnit was removed successfully', { id: toastId });
        //         queryClient.invalidateQueries(['d-licenses']);
        navigate(`/dashboard/measurement-unit`);
        //     },
        //     onError(error: any) {
