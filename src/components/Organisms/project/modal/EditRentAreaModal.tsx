...
export default function EditRentAreamodal({
    setShow,
    projectId,
    isUpdating = false,
    handleSuccess,
    ...
    const handleSubmit = async () => {
        ...
        let submitData: any = { ...values, customRentArea: Number(values.customRentArea), id }
                ...
                <Modal.Body>
                    <div className="body-header p-4 mb-2 d-flex justify-content-between">
                        <Heading fontWeight="bold" fontSize="xl">
                            {isUpdating ? 'Projekto redagavimas' : 'Keisti kiekį'}
                        </Heading>
