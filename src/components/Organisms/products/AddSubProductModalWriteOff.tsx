...
export default function AddNewSubProductModalWriteOff({
    setShow,
    productId,
    userId,
    quantitiesInfo,
    ...
    const handleChangeString = (e: any) => {
        setCustomValue({ ...customValue, [e.name]: e.value });
    };
    ...
    const handleSubmit = async () => {
        ...
        if (isFilePicked) {
                ...
                async onSuccess(_data) {
                    if (_data) {
                        ...
                        if (token) {
                            ...
                            url = `https://www.simis.itvs.lt/api/v1/writeoff-attachments?warehouseProductId=${warehouseProductId}&customFileName=${customValue.customFileName}&createdBy=${values.createdBy}`
            ...
            toast.error('Prašome paremti dokumentu', {
                id: toastId,
            });
        }
