                    ...
                    <tbody>
                        ...
                        {rowsToDisplay.length > 0 &&
                            <tr className="my-2">
                                ...
                                <td></td>
                                <td>
                                    <p style={{ fontSize: isPrint ? '8px' : '' }} className="m-0">{quantityData}</p>
                                </td>
                                <td>
                                    <div>
                                ...
                                <td>
                                    <div>
                                        <p style={{ fontSize: isPrint ? '8px' : '' }} className="m-0">{amountDataRental}</p>
                                        <p style={{ fontSize: isPrint ? '8px' : '' }} className="m-0">{pvmDataRental}</p>
                                        <p style={{ fontSize: isPrint ? '8px' : '' }} className="m-0">{totalDataRental}</p>
                                    </div>
                                </td>
                                <td>
                                    <div>
