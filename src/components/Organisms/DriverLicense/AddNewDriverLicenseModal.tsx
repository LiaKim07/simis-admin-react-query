...
export default function AddNewDriverLicenseModal({
    setShow,
    idData,
    isUpdating = false,
    handleSuccess,
    ...
    const [values, setvalues] = useState<ICreateDriverLicense>({ ...defaultState });
    ...
    const handleSubmit = async () => {
        ...
        if (idData && isUpdating) {
            updateMutation(
                { ...values, id: idData },
                {
                    async onSuccess(_data) {
                        toast.success('DriverLicense was updated successfully', { id: toastId });
            ...
            mutateAsync(values, {
                async onSuccess(_data) {
                    toast.success('DriverLicense was created successfully', { id: toastId });
                ...
                <Modal.Body>
                    <div className="body-header p-4 mb-2 d-flex justify-content-between">
                        <Heading fontWeight="bold" fontSize="xl">
                            {isUpdating ? 'Update DriverLicense' : 'Pridėti kategoriją'}
                        </Heading>
                    ...
                    <div className="body-content px-4 modal-border">
                        <Collapsible isOpen={true} title="Vairuotojų pažymėjimų kategorijos">
